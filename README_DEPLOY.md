...
## Update Notes
- Vocabulary bank expanded to more than 250 built-in words.
- Word and Sound Island navigation buttons were rebuilt: Previous, Listen, Check, Random, and Next.
- Song Mountain now uses melody-based Singing Mode with karaoke lyric highlighting, not robotic text reading.
- Admin PIN: JS 2026.
